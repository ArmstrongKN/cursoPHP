...
<?php
	...
	$base  = "pw2";
	$con   = mysqli_connect($host, $user, $pass, $base);
	$media= floatval($nota1 + $nota2 + $nota3 + $nota4)/4;
    $frequencia = floatval ($falta);
	$res = mysqli_query($con, "UPDATE tb_aluno SET nome='$nome', nota1 = '$nota1', nota2 = '$nota2', nota3 = '$nota3', nota4 = '$nota4', Faltas= '$falta',media=$media, frequencia=$frequencia where RA='$RA';");
...
echo  "</td><td>" . $escrever['RA'] . "</td><td>" . $escrever['nome'] . "</td><td>" . $escrever['nota1'] . "</td><td>" . $escrever['nota2'] . "</td><td>" . $escrever['nota3'] . "</td><td>" . $escrever['nota4'] . "</td><td>" . $escrever['Faltas'] . "</td><td>" . $escrever['media'] . "</td></tr>";
}/*Fim do while*/
