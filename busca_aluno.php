...
echo "<table border=3px><tr><td>RA   </td><td>Nome do Aluno   </td><td>Nota 1   </td><td>Nota 2   </td><td>Nota 3   </td><td>Nota 4   </td><td>Faltas   </td><td>Média   </td></tr>";
...
if ($med > 8 && $fal < 13) {
	echo"<a href = emite_certificado.php>Parabens, clique aqui para gerar seu certificado 	</a>";
	
}else{
	echo"Voce foi reprovado, mas não desista!!!";
} 
?>
